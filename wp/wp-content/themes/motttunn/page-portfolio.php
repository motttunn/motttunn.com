...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/style.css?hash=7409562">
    <?php wp_head(); ?>
  </head>
  <body>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/bundle.js?hash=7409562"></script>
    <?php wp_footer(); ?>
  </body>
</html>