...
<html lang="ja">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/news/style.css?hash=1808935">
    <?php wp_head(); ?>
  </head>
  <body>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/news/app.bundle.js?hash=1808935"></script>
    <?php wp_footer(); ?>
  </body>
</html>