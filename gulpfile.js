...
const commonConfig = {
  pug: {
    ...
    destDirectory: './wp/wp-content/themes/motttunn/',
  },
  sass: {
    srcFile: './src/assets/scss/**/*.scss',
    destDirectory: './wp/wp-content/themes/motttunn/assets/css',
  },
  webpack: {
    srcFile: './src/assets/js/**/*.js',
    // srcFile: './src/assets/ts/**/*.ts',
    destDirectory: './wp/wp-content/themes/motttunn/assets/js',
  }
}
...
gulp.task('bs', () => {
  browserSync.init(null, {
    ...
    //   baseDir: './'
    // },
    proxy: 'http://motttunn.localhost:8080/wp/',
    open: false
  });
});
